...
//////////////////////////////FAVOURITES/////////////////////////////////////////
router
	.route('/cars/favourites')
	.get(authenticate(User), carController.favorites);

router
	.route('/cars/add-to-fav/:id')
	.patch(authenticate(User), favPermessionCheck, carController.addtoFav);
router
	.route('/cars/remove-from-fav/:id')
...
router
	.route('/cars/daily-stats/:min/:max')
	.get(authenticate(User), carController.carDailyStats);
router
	.route('/cars/ban/:id')
	.patch(
		authenticate(User),
